...
public class CryptoTools
{
     ...
     **/
    public static double getIC(byte[] pt)
    {
        double ic = 0;
        int count = 0;
        int trials = 1500;
    ...
    public static byte[] c_encrypt(byte[] pt, int key)
    {
    ...
    public static byte[] c_decrypt(byte[] ct, int key)
    {
    ...
    public static double dotProduct(int [] ar)
    {
        double dotP = 0;
        for(int i = 0; i < ar.length; i++)
        {
            dotP += (double) ar[i] * ENGLISH[i];
        }
        return dotP;
    }
